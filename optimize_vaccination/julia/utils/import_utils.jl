...
function import_all_data(country; source="prem_2020")
...
function import_params(country; source="prem_2020", sf_mode="var")

	psub_country = import_all_data(country; source=source)
	
	p_country = merge(p_base, psub_country)
